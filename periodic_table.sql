...
--
-- Name: properties fk_atproperties_elements; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_atproperties_elements FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
